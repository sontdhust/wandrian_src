...
void Vertices::print_info_list_vertices(std::list< boost::shared_ptr<Vertices> >
	list_vertices){
...
void Vertices::update_list_vertices(std::list< boost::shared_ptr<Vertices> > list_vertices,
	PointPtr position, PointPtr value_befor, PointPtr value_update){
	std::list< boost::shared_ptr<Vertices> >::iterator u;
