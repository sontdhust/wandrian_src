...
#include "../../../include/environment/mstc/base_communicator.hpp"
...
//void BaseCommunicator::write_old_cells_message(std::string message) {
//  // Write old cells
...
//}
//
//void BaseCommunicator::write_status_message(std::string status) {
//  // Write status
...
//}
//
//std::string BaseCommunicator::create_old_cells_message() {
//  std::string messages;
...
//}
//
//std::string BaseCommunicator::create_status_message(IdentifiableCellPtr last_cell) {
...
//}
//
//void BaseCommunicator::read_message_then_update_old_cells() {
//  update_old_cells_from_message(read_old_cells_message());
//}
//
//bool BaseCommunicator::ask_other_robot_still_alive(
...
//}
//
//std::string BaseCommunicator::find_robot_name(IdentifiableCellPtr cell_to_find) {
...
//}
//
//bool BaseCommunicator::find_old_cell(IdentifiableCellPtr cell) {
//  bool value = false;
//  for (std::list<IdentifiableCellPtr>::iterator item = old_cells.begin();
//      item != old_cells.end(); ++item) {
...
//}
//
//void BaseCommunicator::insert_old_cell(IdentifiableCellPtr cell) {
//  old_cells.push_back(
//      IdentifiableCellPtr(
...
std::string BaseCommunicator::get_robot_name() const {
  return robot_name;
}

void BaseCommunicator::set_robot_name(const std::string& robot_name) {
  this->robot_name = robot_name;
}

void BaseCommunicator::set_tool_size(double tool_size) {
  this->tool_size = tool_size;
}

double BaseCommunicator::get_tool_size(){
  return this->tool_size;
}

CellPtr& BaseCommunicator::get_current_cell() {
  return current_cell;
}

void BaseCommunicator::set_current_cell(const CellPtr& current_cell) {
  this->current_cell = current_cell;
}

//std::string BaseCommunicator::read_old_cells_message() {
//  rosbag::Bag bag;
//  std::string msg;
...
//}
//
//void BaseCommunicator::update_old_cells_from_message(std::string msg) {
//  old_cells.clear();
//  double x = 0.0;
//  double y = 0.0;
...
//}
//
//std::string BaseCommunicator::read_status_message() {
//  rosbag::Bag bag;
//  std::string msg;
...
//}
//
//void BaseCommunicator::clear_robots_dead_old_cells(std::string dead_robot_name,
