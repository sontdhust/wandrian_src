...
####Prefered command:
    ...
    $ roslaunch wandrian run_practically.launch mn:=prefered ts:=0.4 sp_x:=0.6 sp_y:=-0.6 pn:=fss lv:=0.18 pav:=1.1 nav:=0.9 pr_c:=0.4 pr_s:=0.2 af_r:=3.0 e_rd:=0.12 e_md:=0.96 e_p:=0.04 d_p:=0.01
