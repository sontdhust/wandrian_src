...
#ifndef WANDRIAN_MSTC_ONLINE_INCLUDE_PLANS_SPIRAL_STC_CELL_HPP_
#define WANDRIAN_MSTC_ONLINE_INCLUDE_PLANS_SPIRAL_STC_CELL_HPP_
...
#endif /* WANDRIAN_MSTC_ONLINE_INCLUDE_PLANS_SPIRAL_STC_CELL_HPP_ */
