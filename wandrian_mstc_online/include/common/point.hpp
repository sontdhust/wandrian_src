...
#ifndef WANDRIAN_MSTC_ONLINE_INCLUDE_COMMON_POINT_HPP_
#define WANDRIAN_MSTC_ONLINE_INCLUDE_COMMON_POINT_HPP_
...
#endif /* WANDRIAN_MSTC_ONLINE_INCLUDE_COMMON_POINT_HPP_ */
