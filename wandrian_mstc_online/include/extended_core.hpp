...
#ifndef WANDRIAN_MSTC_ONLINE_INCLUDE_EXTENDED_CORE_HPP_
#define WANDRIAN_MSTC_ONLINE_INCLUDE_EXTENDED_CORE_HPP_
...
#endif /* WANDRIAN_MSTC_ONLINE_INCLUDE_EXTENDED_CORE_HPP_ */
