...
#ifndef WANDRIAN_RUN_INCLUDE_ENVIRONMENT_PARTIALLY_OCCUPIABLE_CELL_HPP_
#define WANDRIAN_RUN_INCLUDE_ENVIRONMENT_PARTIALLY_OCCUPIABLE_CELL_HPP_
...
#endif /* WANDRIAN_RUN_INCLUDE_ENVIRONMENT_PARTIALLY_OCCUPIABLE_CELL_HPP_ */
