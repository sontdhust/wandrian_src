...
#ifndef WANDRIAN_RUN_INCLUDE_PLANS_MSTC_ONLINE_PARTIALLY_OCCUPIABLE_CELL_HPP_
#define WANDRIAN_RUN_INCLUDE_PLANS_MSTC_ONLINE_PARTIALLY_OCCUPIABLE_CELL_HPP_
...
#endif /* WANDRIAN_RUN_INCLUDE_PLANS_MSTC_ONLINE_PARTIALLY_OCCUPIABLE_CELL_HPP_ */
