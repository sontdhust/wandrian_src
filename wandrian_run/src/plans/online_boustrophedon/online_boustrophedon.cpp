...
void OnlineBoustrophedon::initialize(PointPtr starting_point, double robot_size) {
...
void OnlineBoustrophedon::set_environment(EnvironmentPtr environment) {
...
void OnlineBoustrophedon::go_straight(CellPtr neighbor, CellPtr current, VectorPtr orientation){
  std::cout << "\n";
...
void OnlineBoustrophedon::turn_left(CellPtr neighbor_left, CellPtr current, VectorPtr orientation){
  std::cout << "\n";
...
void OnlineBoustrophedon::turn_right(CellPtr neighbor_right, CellPtr current, VectorPtr orientation){
  std::cout << "\n";
